...
class MapWindow(ctk.CTkToplevel):
    ...
    locations = {'SHELF 10', 'SHELF 26', 'TUB 3', 'SHELF 28', 'SHELF 1', 'TUB 9', 'WHITE TABLE', 'TUB 13', 'LEFT WALL', 'SHELF 5', 'SHELF 14', 'SHELF 12', 'SHELF 17', 'BACK WALL', 'SHELF 3', 'TUB 10', 'SHELF 16', 'SHELF 6', 'TUB 2', 'TUB 17', 'SHELF 21', 'SHELF 23', 'SHELF 25', 'TUB 6', 'MINIATURE TANKS BOX', 'SHELF 11', 'SHELF 8', 'TUB 15', 'TUB 1', 'TUB 5', 'BOX UNDER WHITE TABLE', 'TUB 12', 'TUB 16', 'SHELF 7', 'SHELF 13', 'SLOTCAR SECTION', 'SHELF 19', 'SHELF 22', 'SHELF 2', 'TUB 11', 'SHELF 9', 'SLOTCAR BOX', 'SHELF 4', 'SHELF 18', 'VACFORM BOX', 'TUB 7', 'TUB 8', 'TUB 14', 'DIECAST BOX', 'RIGHT AND SOUTH WALL', 'None', 'MICROWAVE BOX', 'SHELF 20', 'SHELF 27', 'SHELF 15', 'TUB 4', 'SMALL ROOM SHELF', 'SHELF 24'}
    
    class Shelf:
        
        def __init__(self,master,label,w,h,x,y):
            ...
            self.label_box.bind("<Enter>", self.on_enter)
            self.label_box.bind("<Leave>", self.on_leave)
            
            self.box.bind("<Button-1>", self.on_click)
            
            
            self.label_box.bind("<Button-1>", self.on_click)
            
            
        def on_enter(self, event):
                self.box.configure(border_width=5)
    ...
    def __init__(self,master):
        ...
        self.results_window = ctk.CTkScrollableFrame(
        ...
        self.results_window.place(x=0,y=0)
        ...
        for i in range(1,3):
            ...
            for j in range(1,8):
                ...
                shelf = self.Shelf(self,f"SHELF {shelf_number}",70,70,x + 75 * (j - 1),z)
            
            
        shelf = self.Shelf(self,f"BACK WALL",80,70,1525 - 80,240)
        shelf = self.Shelf(self,f"SLOTCAR\nSECTION",100,70,1525 - 100,360)
        shelf = self.Shelf(self,f"RIGHT\nAND\nSOUTH\nWALL",80,300,1525 - 80,480)
        shelf = self.Shelf(self,f"RIGHT AND SOUTH WALL",300 + 150,70,x + 230,750)
        shelf = self.Shelf(self,f"BACK WALL",300,50,1080,0)
        
        shelf = self.Shelf(self,f"LEFT\nWALL",70,120,700,120)
        shelf = self.Shelf(self,f"MICROWAVE\nBOX",90,70,700,280)
        
        shelf = self.Shelf(self,f"SHELF 28",70,70,600,550)
        shelf = self.Shelf(self,f"SHELF 27",70,70,675,550)
        
        shelf = self.Shelf(self,f"WHITE\nTABLE",60,70,725 + 50,400)
        shelf = self.Shelf(self,f"BOX\nUNDER\nWHITE\nTABLE",60,70,650 + 50,400)
        shelf = self.Shelf(self,f"MINI\nATURE\nTANKS\nBOX",60,70,575,400)
        ...
        for i in range(1,5):
            ...
            for j in range(1,5) if i < 4 else range(1,6):
            
                tub_number += 1
                
                shelf = self.Shelf(self,f"TUB\n{tub_number}",30,30,x + 35 * (j - 1),z)
                shelf.label_box.configure(font=(None, 8))
                shelf.box.configure(border_width=2)

        shelf = self.Shelf(self,f"DIECAST\nBOX",50,50,575,730)
        shelf.label_box.configure(font=(None, 8))
        shelf.box.configure(border_width=2)
        ...
        shelf = self.Shelf(self,f"SAMLL ROOM SHELF",100,50,575,675)
        shelf.label_box.configure(font=(None, 8))
        shelf.box.configure(border_width=2)
